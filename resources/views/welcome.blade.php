        ...
        <div class="row justify-content-center mt-5">
            <div class="col-lg-9 text-center text-lg-start">
                    ...
                    <div class="title">
                        ...
                        <form action="" method="GET">
                            <div class="input-group mb-3">
                                <input type="search" class="form-control" placeholder="Cari" name="keyword" aria-label="Recipient's username" aria-describedby="basic-addon2">
                    ...
                    <table class="table table-bordered table-striped table-hover" id="example1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$s->nisn}}</td>
                                <td>{{$s->nama}}</td>
                                <td> <a href="{{ route('siswa.show', [$s->id])}}"><button type="submit" class="btn btn-outline-success btn-fw">Aspirasi</button></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <section id="contact" class="contact">
                    <div class="container" id="lapor" data-aos="fade-up">

                        <div class="section-title">
                            <h2>Buat laporan</h2>
                            <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p>
                        </div>
                        <form id="contact-form" enctype="multipart/form-data" action="{{ route('pelaporan.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="section-heading">
                                        <h2>Laporkan Masalah <span>Anda</span></h2>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
                                        <select name="siswa_id" class="form-select" id="select">
                                            <option selected disabled>NISN</option>
                                ...
                                <div class="col-lg-12 mt-4">
                                    <fieldset>
                                        <select name="kategori_id" class="form-select" id="select">
                                ...
                                <div class="col-lg-12 mt-3">
                                    <fieldset>
                                        <textarea type="text" class="form-control @error('lokasi') is-invalid @enderror" name="lokasi" id="lokasi" placeholder="Lokasi" autocomplete="on"></textarea>
                                    </fieldset>
                                    @error('lokasi')
