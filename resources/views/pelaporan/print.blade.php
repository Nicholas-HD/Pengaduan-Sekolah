    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Admin Call Center Sekolah</span>
            </a>
          ...
          <img src="{{asset('admin/dist/img/user2-160x160.jpg')}}" class="img-circle elevation-2" alt="User Image">
                ...
                <div class="info">
                    <a href="{{url('home')}}" class="d-block justify-content-center">{{Auth::user()->name}}</a>
                </div>
            </div>
               ...
               with font-awesome or any other icon font library -->
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('siswa/create')}}" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('pelaporan.index')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Pelaporan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('pelaporan.print')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Cetak</p>
                            </a>
                        </li>
